...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CC': 'musl-clang',
 'CCSHARED': '-fPIC',
 'CFLAGS': '-fno-strict-aliasing -DNDEBUG -g -fwrapv -O3 -Wall -fPIC '
 ...
 'CONFIGURE_CFLAGS': '-fPIC -I/tools/deps/include '
                     ...
                     '-I/tools/deps/libedit/include -static',
 'CONFIGURE_CFLAGS_NODIST': '-flto -g -std=c11 '
 ...
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/build/Python-3.11.6/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/build/Python-3.11.6/lcov-report',
 ...
 'LIBEXPAT_CFLAGS': '-fno-strict-aliasing -DNDEBUG -g -fwrapv -O3 -Wall -fPIC '
                    '-I/tools/deps/include -I/tools/deps/include/ncursesw '
                    '-I/tools/deps/libedit/include -static -flto -g -std=c11 '
                    '-Werror=implicit-function-declaration '
                    '-fvisibility=hidden  -I./Include/internal -I. -I./Include '
                    '-fPIC -I/tools/deps/include '
                    '-I/tools/deps/include/ncursesw '
                    '-I/tools/deps/libedit/include -static -fPIC',
 'LIBEXPAT_HEADERS': '\\',
 'LIBEXPAT_OBJS': '\\',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '-lm',
 ...
 'LIBMPDEC_CFLAGS': '-DCONFIG_64=1 -DANSI=1 -DHAVE_UINT128_T=1 '
                    '-fno-strict-aliasing -DNDEBUG -g -fwrapv -O3 -Wall -fPIC '
                    '-I/tools/deps/include -I/tools/deps/include/ncursesw '
                    '-I/tools/deps/libedit/include -static -flto -g -std=c11 '
                    '-Werror=implicit-function-declaration '
                    '-fvisibility=hidden  -I./Include/internal -I. -I./Include '
 ...
 'MODBUILT_NAMES': '_asyncio  _bisect  _blake2  _bz2  _codecs_cn  _codecs_hk  '
                   ...
                   'unicodedata  xxsubtype  zlib  atexit  faulthandler  posix  '
 ...
 'MODDISABLED_NAMES': '_gdbm  _scproxy  _testcapi  nis  ossaudiodev  xx  '
 ...
 'MODOBJS': 'Modules/_asynciomodule.o  Modules/_bisectmodule.o  '
            ...
            'Modules/_cryptmodule.o  Modules/_csv.o  Modules/_ctypes/_ctypes.o '
            ...
            'Modules/selectmodule.o  Modules/spwdmodule.o  '
 ...
 'NO_AS_NEEDED': '',
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/tools/deps/include',
 'OPENSSL_LDFLAGS': '-L/tools/deps/lib',
 ...
 'PYTHONPATH': '',
 'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/build/Python-3.11.6 '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
                     '/build/Python-3.11.6/`cat pybuilddir.txt`:)./Lib '
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-fno-strict-aliasing -DNDEBUG -g -fwrapv -O3 '
                             '-Wall -fPIC -I/tools/deps/include '
                             '-I/tools/deps/include/ncursesw '
 ...
 'PY_CFLAGS': '-fno-strict-aliasing -DNDEBUG -g -fwrapv -O3 -Wall -fPIC '
              '-I/tools/deps/include -I/tools/deps/include/ncursesw '
              '-I/tools/deps/libedit/include -static',
 'PY_CFLAGS_NODIST': '-flto -g -std=c11 -Werror=implicit-function-declaration '
                     '-fvisibility=hidden  -I./Include/internal',
 'PY_COERCE_C_LOCALE': 1,
 'PY_CORE_CFLAGS': '-fno-strict-aliasing -DNDEBUG -g -fwrapv -O3 -Wall -fPIC '
                   '-I/tools/deps/include -I/tools/deps/include/ncursesw '
                   '-I/tools/deps/libedit/include -static -flto -g -std=c11 '
 ...
 'PY_LDFLAGS_NOLTO': '-L/tools/deps/lib -Wl,--exclude-libs,ALL '
                     '-L/tools/deps/libedit/lib -static -flto=thin',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': '_PYTHON_PROJECT_BASE=/build/Python-3.11.6 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/build/Python-3.11.6/`cat pybuilddir.txt`:)./Lib '
               '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_x86_64-linux-gnu '
               '/tools/host/bin/python3.11',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': '_PYTHON_PROJECT_BASE=/build/Python-3.11.6 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/build/Python-3.11.6/`cat pybuilddir.txt`:)./Lib '
               '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_x86_64-linux-gnu '
 ...
 'abs_builddir': '/build/Python-3.11.6',
 'abs_srcdir': '/build/Python-3.11.6',
